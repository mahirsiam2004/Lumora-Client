...
import { 
  FiHome, FiUser, FiCalendar, FiCreditCard, FiGrid, 
  FiPackage, FiUsers, FiBarChart2, FiMenu, FiX,
...
const DashboardLayout = () => {
  ...
  const adminLinks = [
    { to: '/dashboard/admin', label: 'Admin Dashboard', icon: FiGrid },
    { to: '/dashboard/admin/services', label: 'Manage Services', icon: FiPackage },
    { to: '/dashboard/admin/bookings', label: 'Manage Bookings', icon: FiCalendar },
    { to: '/dashboard/admin/decorators', label: 'Manage Decorators', icon: FiUsers },
    { to: '/dashboard/admin/analytics', label: 'Analytics', icon: FiBarChart2 },
  ];

  const decoratorLinks = [
    { to: '/dashboard/decorator', label: 'Decorator Dashboard', icon: FiGrid },
    { to: '/dashboard/decorator/projects', label: 'My Projects', icon: FiBriefcase },
    { to: '/dashboard/decorator/schedule', label: 'Today\'s Schedule', icon: FiClock },
    { to: '/dashboard/decorator/earnings', label: 'Earnings', icon: FiDollarSign },
  ];
